# From http://djangosnippets.org/snippets/2892/
#
...
class UseMacroNode(template.Node):
    ...
    def __init__(self, parser, macro_name, fe_args, fe_kwargs, context_only):
        self.parser = parser
    ...
    def render(self, context):
        try:
            self.macro = self.parser._macros[self.macro_name]
...
def parse_usemacro(parser, token):
    ...
    return parser, macro_name, fe_args, fe_kwargs
