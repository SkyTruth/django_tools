...
urlpatterns = django.conf.urls.patterns('',
    ...
    django.conf.urls.url(r'^siteinfo/help-out/?$', django.views.generic.TemplateView.as_view(template_name='appomatic_siteinfo/helpout.html'), name="appomatic_siteinfo_helpout"),
    django.conf.urls.url(r'^siteinfo/about/?$', django.views.generic.TemplateView.as_view(template_name='appomatic_siteinfo/about.html'), name="appomatic_siteinfo_about"),
