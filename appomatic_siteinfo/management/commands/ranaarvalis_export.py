...
class Command(django.core.management.base.BaseCommand):
    ...
    def handle2(self, *args, **kwargs):
        with contextlib.closing(django.db.connection.cursor()) as cur:
            cur.execute("""
select latitude y, longitude x from appomatic_siteinfo_site s join appomatic_siteinfo_locationdata l on s.locationdata_ptr_id = l.basemodel_ptr_id join appomatic_siteinfo_basemodel b on l.basemodel_ptr_id = b.id join region r on st_contains(r.the_geom, l.location) and r.name = 'Tioga County, PA'
            """)
