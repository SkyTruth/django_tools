    ...
    def handle2(self, *args, **kwargs):
        with contextlib.closing(django.db.connection.cursor()) as cur:
            ...
            for site in fcdjangoutils.sqlutils.dictreader(cur):
                ...
                dummy, top, dummy = geod.fwd(site['x'], site['y'], 0, 375)
                left, dummy, dummy = geod.fwd(site['x'], site['y'], 270, 375)
                right, dummy, dummy = geod.fwd(site['x'], site['y'], 90, 375)
                dummy, bottom, dummy = geod.fwd(site['x'], site['y'], 180, 375)
